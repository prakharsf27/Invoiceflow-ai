...
const mockInvoices = [
  ...
  },
  {
    ...
    supplierGstin: '29ABCDE5555F1Z2',
    supplierEmail: 'billing@apexcloud.in',
    supplierPhone: '+91 80 4001 2233',
    amount: 118000,
    currency: 'INR',
    subtotal: 100000,
    tax: 18000,
    ...
    items: [
      {
        id: 'item-20-1',
        description: 'Dedicated Cloud Infrastructure - Tier 2',
        quantity: 1,
        unitPrice: 100000,
        taxRate: 18,
        taxAmount: 18000,
    ...
    aiChecks: [
      { id: 'c20-1', title: '3-Way PO Match Verification', passed: true, type: 'success', detail: 'PO-2026-TEST-020 100% matched' },
      { id: 'c20-2', title: 'Math & Tax Consistency', passed: true, type: 'success', detail: 'Subtotal and 18% GST verified' },
    ],
    aiRecommendation: '100% matched against PO. Recommended for automated payment release.',
    evidence: [
      {
        title: 'PO Financial Reconciliation',
        invoiceValue: '₹1,18,000',
        referenceValue: '₹1,18,000 (PO-2026-TEST-020)',
        difference: '₹0 Discrepancy (100% Match)',
        explanation: 'Invoice matches authorized purchase order value exactly.',
      },
    ],
  },
  {
    ...
    supplierGstin: '27AABCP1122D1Z9',
    supplierEmail: 'sales@datacoresupplies.com',
    supplierPhone: '+91 22 2847 9900',
    amount: 590000,
    currency: 'INR',
    subtotal: 500000,
    tax: 90000,
    ...
    bankDetails: {
      ...
      ifsc: 'UTIB0000045',
      bankName: 'Axis Bank, Fort Mumbai',
      isChangedFromPrevious: false,
    },
    items: [
      {
        id: 'item-21-1',
        description: 'High-Density Server Racks & Cable Trays',
        quantity: 10,
        unitPrice: 50000,
        taxRate: 18,
        taxAmount: 90000,
    ...
    aiChecks: [
      { id: 'c21-1', title: 'PO Amount Comparison', passed: false, type: 'critical', detail: 'Invoice amount exceeds PO-2026-TEST-021 total of ₹5,36,364 by +10%' },
      { id: 'c21-2', title: 'Unit Pricing Check', passed: false, type: 'warning', detail: 'Billed unit rate is higher than approved contract' },
    ],
    aiRecommendation: 'Hold payment. Invoice exceeds approved PO limit by 10%. AP approval or variance acceptance required.',
    evidence: [
      {
        title: 'Total Amount Comparison',
        invoiceValue: '₹5,90,000',
        referenceValue: '₹5,36,364 (PO-2026-TEST-021)',
        difference: '+10% Overrun',
        explanation: 'Invoice total is 10% higher than authorized PO amount.',
      },
    ],
  },
  {
    ...
    supplierId: 'sup-precision-eng',
    supplierName: 'Precision Engineering Works',
    supplierGstin: '33AABCT9988K1Z5',
    supplierEmail: 'accounts@precisioneng.in',
    supplierPhone: '+91 44 2250 8877',
    amount: 175000,
    currency: 'INR',
    subtotal: 148305,
    tax: 26695,
    ...
    bankDetails: {
      accountNumber: '334400010005678',
      ifsc: 'PUNB0004500',
      bankName: 'Punjab National Bank, Chennai',
      isChangedFromPrevious: false,
    },
    items: [
      {
        id: 'item-18-1',
        description: 'Custom CNC Aluminum Brackets',
        quantity: 250,
        unitPrice: 593.22,
        taxRate: 18,
        taxAmount: 26695,
    ...
    aiChecks: [
      { id: 'c18-1', title: 'Purchase Order Reference', passed: false, type: 'warning', detail: 'No Purchase Order reference found on document' },
      { id: 'c18-2', title: 'Supplier Validation', passed: true, type: 'success', detail: 'Active vendor with approved GSTIN' },
    ],
    aiRecommendation: 'Missing PO on document. Route to department procurement lead for retrospective PO reference.',
    evidence: [],
  },
  {
    id: 'inv-test-016',
    ...
    supplierGstin: '06AAACB3344J1Z3',
    supplierEmail: 'finance@bharatlogistics.co.in',
    ...
    paymentTerms: 'Net 15 Days',
    bankDetails: {
      accountNumber: '004505009876',
      ifsc: 'ICIC0000045',
      bankName: 'ICICI Bank, Gurgaon CyberCity',
      isChangedFromPrevious: false,
    },
    items: [
      {
        id: 'item-16-1',
        description: 'Heavy Freight Transportation - Gurgaon to Pune',
        quantity: 1,
        unitPrice: 100000,
        taxRate: 18,
        taxAmount: 18000,
    ...
    aiChecks: [
      { id: 'c16-1', title: 'Math & Tax Consistency Check', passed: false, type: 'critical', detail: 'Subtotal (₹1,00,000) + Tax (₹18,000) = ₹1,18,000, does not equal stated Total (₹1,35,000)' },
      { id: 'c16-2', title: 'PO Reference Validated', passed: true, type: 'success', detail: 'Linked to PO-2026-TEST-016' },
    ],
    aiRecommendation: 'Critical math inconsistency. Billed total exceeds itemized subtotal + GST by ₹17,000. Request revised invoice.',
    evidence: [
      {
        title: 'Tax & Math Verification',
        invoiceValue: '₹1,35,000',
        referenceValue: '₹1,18,000 (Subtotal + GST)',
        difference: '+₹17,000 Inconsistency',
        explanation: 'Line items sum to ₹1,18,000 but invoice header claims ₹1,35,000.',
      },
    ],
  },
  {
    ...
    supplierGstin: '19AAFCO7788P1Z1',
    supplierEmail: 'invoices@omnitech.in',
    supplierPhone: '+91 33 2289 4400',
    amount: 210000,
    currency: 'INR',
    subtotal: 177966,
    tax: 32034,
    ...
    bankDetails: {
      ...
      ifsc: 'SBIN0000123',
      bankName: 'SBI Park Street, Kolkata',
      isChangedFromPrevious: false,
    },
    items: [
      {
        id: 'item-19-1',
        description: 'Electronic Sensors & Transducers Kit',
        quantity: 50,
        unitPrice: 3559.32,
        taxRate: 18,
        taxAmount: 32034,
    ...
    aiChecks: [
      { id: 'c19-1', title: 'PO Database Reconciliation', passed: false, type: 'warning', detail: 'PO-2026-TEST-019 was not found in enterprise procurement system' },
      { id: 'c19-2', title: 'Duplicate Invoice Check', passed: true, type: 'success', detail: 'Unique invoice record' },
    ],
    aiRecommendation: 'Referenced PO not found in ERP. Verify if PO was raised under alternate identifier or pending ERP sync.',
    evidence: [],
  },
];
...
const mockPurchaseOrders = [
  ...
  },
  {
    ...
    matchStatus: 'matched',
    items: [
      { id: 'po-item-20', description: 'Dedicated Cloud Infrastructure - Tier 2', quantity: 1, unitPrice: 100000, total: 118000 },
    ],
  },
  {
    id: 'po-test-021',
    ...
    items: [
      { id: 'po-item-21', description: 'High-Density Server Racks & Cable Trays', quantity: 10, unitPrice: 45454.55, total: 536364 },
    ],
  },
];
